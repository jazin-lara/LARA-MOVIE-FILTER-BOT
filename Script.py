...
class script(object):
    START_TXT = """<b>ʜᴇʟʟᴏ {} 👋 ഞാൻ ഏറ്റവും പുതിയതും ശക്തവുമായ ഓട്ടോ ഫിൽട്ടർ ബോട്ടാണ്, നിങ്ങൾക്ക് നിങ്ങളുടെ ഗ്രൂപ്പിൽ എന്നെ ഉപയോഗിക്കാം....</b>"""
...
‣ ᴅᴇᴠᴇʟᴏᴘᴇʀ : <a href='https://t.me/Friday_Filim_House'>ᴏᴡɴᴇʀ</a> 
...
ᴅɪᴅ ʏᴏᴜ ᴍᴇᴀɴ ᴀɴʏ ᴏɴᴇ ᴏꜰ ᴛʜᴇꜱᴇ?"""
    ...
    I_CUDNT = """<b>Movie not Found Dude 😔 

 Do search in google and copy that name and send if that movies OTT released</b>"""
...
𝗥𝗲𝗾𝘂𝗲𝘀𝘁 𝗠𝗢𝗩𝗜𝗘 ➲ <a href=https://t.me/Friday_Filim_House
> @OTT STREAMING UPDATES </a></b>"""
